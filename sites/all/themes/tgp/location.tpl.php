...
<div class="location vcard" itemscope itemtype="http://schema.org/PostalAddress">
  <div class="adr">
    ...
    <?php if (!empty($city)): ?>
      ...
      <?php print $city; ?></span><?php if (!empty($province)) : ?><?php print ', '; ?>
      <?php endif; ?>
    <?php endif; ?>
    ...
    <?php if (!empty($www)): ?>
      <div class="www">
        <abbr class="type" title="www"><?php print t("Website"); ?>:</abbr>
        <span><a href="<?php print $www; ?>" itemprop="www" target="_blank"><?php print $www; ?></a></span>
      </div>
    <?php endif; ?>
    <?php if (!empty($email)): ?>
      <div class="email">
        <abbr class="type" title="email"><?php print t("EMail"); ?>:  </abbr>
