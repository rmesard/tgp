 ...
 */
function gaa_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['gaa_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('gaa sample setting'),
  '#default_value' => theme_get_setting('gaa_example'),
